...
export default {
    ...
    give(mess) {
        const m = mess || this.options.message[Math.floor(Math.random() * this.options.message.length)],
            n = {
                dismissable: true
            };
    ...
    toggle() {
        ...
        if (this.interval > 0) {
            ...
            console.log("Disable");
            this.give("Ok I'll stop, hope you have a fantastic day.");
            return;
        }

        this.give("Whooo!! Time to get some motivated work done.");
